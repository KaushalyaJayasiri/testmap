...
lyr_ESRIWorldTopo_0.setVisible(true);lyr_SriLankaDistricts_1.setVisible(true);lyr_SriLankaWaterways_2.setVisible(true);lyr_SriLankaRoads_3.setVisible(true);
var layersList = [lyr_ESRIWorldTopo_0,lyr_SriLankaDistricts_1,lyr_SriLankaWaterways_2,lyr_SriLankaRoads_3];
...
lyr_SriLankaDistricts_1.set('fieldLabels', {'shapeName': 'inline label - always visible', 'shapeISO': 'hidden field', 'shapeID': 'no label', 'shapeGroup': 'no label', 'shapeType': 'no label', });
